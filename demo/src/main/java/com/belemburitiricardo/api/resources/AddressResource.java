package com.belemburitiricardo.api.resources;
...
import com.belemburitiricardo.api.services.AddressService;
...
public class AddressResource {
	...
	public ResponseEntity<Page<AddressDTO>> findAll(
			...
			@RequestParam(value = "orderBy", defaultValue = "publicPlace") String orderBy			
			){
		
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);
		
		Page<AddressDTO> list = addressService.findAllPaged(pageRequest);
